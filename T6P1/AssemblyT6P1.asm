...
irq1Handler: ; APP TRANSFER

    jsrd #AppTransferDriver
...
;   r1 <= &App
    ldh r1, #appTransferStart
    ldl r1, #appTransferStart
    
;   r2 <= Offset
    ldh r2, #appTransferOffset
    ldl r2, #appTransferOffset
    ld r2, r0, r2
    
;   r3 <= Ponteiro para linha atual / instrução atual
    ldh r3, #appTransferPointer
    ldl r3, #appTransferPointer
    ld r3, r0, r3
...
; Array com endereços das chamadas de sistema
...
; Offset da linha atual (Parte Alta ou Baixa)
appTransferOffset:        db #0

; Instrução sendo transferida
appTransferPointer:       db #0

; App Transfer Start (Should be last label to be declared)
appTransferStart:         db #0
