...
;   r1 <= &arrayPorta
    ldh r1, #arrayPorta ; Carrega &arrayPorta
    ldl r1, #arrayPorta ; Carrega &arrayPorta

    ld r1, r0, r1 ; Carrega indexador de arrayPorta  [ arrayPorta[r4] -> &PortData ]
